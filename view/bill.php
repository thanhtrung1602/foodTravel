...
<body>
    ...
    <script>
        const chekedPay = document.querySelector('.pay-bill');
        const sub = document.querySelector('.sub-bill');
        const checkedBoxs = document.querySelectorAll('.del-check__bill');
        ...
        let call = chekedPay.onclick =function (e) {
            if(e.target.checked) {
                console.log(this);
                alert("bạn chọn thanh toán bằng tiền mặt");
            } else {
                alert('bạn đã bỏ chọn thanh toán bằng tiền mặt')
            }
        }
